...
public class ElasticsearchIO {
  ...
  public static Read read() {
    ...
    return new org.apache.beam.sdk.io.elasticsearch.AutoValue_ElasticsearchIO_Read.Builder()
  ...
  public static Write write() {
    return new org.apache.beam.sdk.io.elasticsearch.AutoValue_ElasticsearchIO_Write.Builder()
  ...
  public abstract static class ConnectionConfiguration implements Serializable {
    ...
    public static ConnectionConfiguration create(String[] addresses, String index, String type){
      ...
      ConnectionConfiguration connectionConfiguration =
          new org.apache.beam.sdk.io.elasticsearch
              .AutoValue_ElasticsearchIO_ConnectionConfiguration.Builder()
  ...
  static int getBackendVersion(ConnectionConfiguration connectionConfiguration) {
    try (RestClient restClient = connectionConfiguration.createClient()) {
      ...
      checkArgument((backendVersion == VALID_ES_VERSION),
          ...
          + "This version of the ElasticsearchIO is only compatible with Elasticsearch v6.x",
          backendVersion);
